...
python3 -m ectf_tools build.car_fob_pair --design . --name test_design --deployment test_deployment --car-out ./outputs/test_car --fob-out ./outputs/test_paired_fob --car-name car --fob-name paired_fob --car-id 1000 --pair-pin 001234 --car-feature1-secret "SECRET!"
